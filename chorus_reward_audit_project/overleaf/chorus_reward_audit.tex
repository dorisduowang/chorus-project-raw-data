...
projects, and computational resources. The recovered project folder contained the registry and hypergraph data, but not the model artifacts needed to reproduce the original text-surprise and representation-contrast scores exactly. I therefore rebuilt the analysis as a transparent reconstruction. The project creates a paper-level panel, defines clearly labeled proxy scores, and uses citation counts only as an external uptake measure. The rebuilt audit suggests a directional ranking risk. A text
