...
while making quieter papers with stronger external uptake less visible. This is why I treat the CHORUS case as a small audit of a broader design problem. AI systems often do not make the final decision, but they shape which options become visible before a person decides. An AI assistant does not only answer questions. It also
...
research lab. In CHORUS, the search problem is across papers and concepts. In entrepreneurial AI advice, the search problem is across possible actions, constraints, and uses of AI inside the firm. In both cases, the quality
