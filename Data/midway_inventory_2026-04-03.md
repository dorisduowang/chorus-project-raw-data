...
**Last Updated:** 2026-04-03T02:00:06.141644
**Total Resources:** 138 directories
...
### openalex-snapshot
- **Also known as:** MAG, Microsoft Academic, Microsoft Academic Graph, OpenAlex, OA
...
- **Contains:** institution data, paper metadata, model configs, author data, citation links, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, model configs, web pages, model weights, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** institution data, paper metadata, patent links, author data, citation data, citation links, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, ArXiv, arxiv, arXiv, BioRxiv, biorxiv, medRxiv, medrxiv, bioRxiv
...
- **Contains:** paper metadata, patent links, author data, citation data, grant data, venue data
- **Status:** VALUABLE, ACTIVE
