...
**Last Updated:** 2026-05-12T02:00:08.107498
...
- **Also known as:** SemanticScholar, Semantic Scholar, S2, S2AG
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, OA, Microsoft Academic, MAG, OpenAlex
...
- **Contains:** model configs, model weights, paper metadata, citation links, institution data, author data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** HTML, model configs, model weights, text, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, messages, posts, channel data, user data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, citation links, grant data, institution data, author data, patent links, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, arXiv, BioRxiv, MedRxiv, arxiv, ArXiv, medrxiv, medRxiv, bioRxiv
...
- **Contains:** paper metadata, grant data, venue data, patent links, author data, citation data
- **Status:** VALUABLE, ACTIVE
