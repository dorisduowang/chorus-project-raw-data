...
**Last Updated:** 2026-03-06T02:00:08.392165
...
### openalex-snapshot
- **Also known as:** MAG, OA, OpenAlex, Microsoft Academic, Microsoft Academic Graph
...
- **Contains:** paper metadata, model weights, model configs, author data, institution data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, text, model configs, HTML, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, user data, channel data, posts, messages
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, citation data, author data, patent links, institution data, citation links, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medrxiv, ArXiv, BioRxiv, MedRxiv, biorxiv, arXiv, bioRxiv, arxiv, medRxiv
...
- **Contains:** paper metadata, citation data, venue data, author data, patent links, grant data
- **Status:** VALUABLE, ACTIVE
