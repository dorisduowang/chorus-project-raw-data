...
**Last Updated:** 2026-03-31T02:00:07.484704
...
- **Also known as:** S2, S2AG, SemanticScholar, Semantic Scholar
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** patent links, grant data, paper metadata, citation data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** institution data, author data, model weights, paper metadata, model configs, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, model weights, web pages, model configs, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** institution data, author data, citation data, paper metadata, grant data, citation links, patent links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** BioRxiv, arxiv, medRxiv, biorxiv, medrxiv, arXiv, MedRxiv, ArXiv, bioRxiv
...
- **Contains:** author data, citation data, paper metadata, grant data, patent links, venue data
- **Status:** VALUABLE, ACTIVE
