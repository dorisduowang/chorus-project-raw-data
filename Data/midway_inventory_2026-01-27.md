...
**Last Updated:** 2026-01-27T02:00:03.243418
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, paper metadata, author data, grant data, institution data, citation links, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, ArXiv, medrxiv, arXiv, bioRxiv, medRxiv, arxiv, MedRxiv, BioRxiv
...
- **Contains:** patent links, paper metadata, venue data, author data, grant data, citation data
- **Status:** VALUABLE, ACTIVE
