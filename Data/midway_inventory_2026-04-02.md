...
**Last Updated:** 2026-04-02T02:00:06.810243
**Total Resources:** 137 directories
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** patent links, grant data, citation data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** author data, paper metadata, citation links, model configs, model weights, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, grant data, citation data, patent links, paper metadata, citation links, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, medRxiv, BioRxiv, ArXiv, medrxiv, MedRxiv, arxiv, biorxiv, bioRxiv
...
- **Contains:** author data, grant data, citation data, patent links, venue data, paper metadata
- **Status:** VALUABLE, ACTIVE
