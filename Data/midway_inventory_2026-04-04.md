...
**Last Updated:** 2026-04-04T02:00:05.722723
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, MAG, Microsoft Academic Graph, OA, OpenAlex
...
- **Contains:** model weights, paper metadata, institution data, model configs, author data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, messages, posts, comments, user data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, citation data, institution data, grant data, author data, patent links, citation links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, bioRxiv, arxiv, medrxiv, MedRxiv, ArXiv, biorxiv, BioRxiv, medRxiv
...
- **Contains:** paper metadata, venue data, citation data, grant data, author data, patent links
- **Status:** VALUABLE, ACTIVE
