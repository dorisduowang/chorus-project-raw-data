...
**Last Updated:** 2026-04-27T02:00:06.166814
...
- **Contains:** author data, citation links, model weights, paper metadata, model configs, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, channel data, messages, posts, user data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, author data, citation links, patent links, paper metadata, institution data, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** ArXiv, medRxiv, arXiv, bioRxiv, medrxiv, arxiv, MedRxiv, BioRxiv, biorxiv
...
- **Contains:** grant data, venue data, author data, patent links, paper metadata, citation data
- **Status:** VALUABLE, ACTIVE
