...
**Last Updated:** 2026-01-20T02:00:04.135739
...
- **Also known as:** SemanticScholar, Semantic Scholar, S2AG, S2
...
- **Contains:** author data, model weights, institution data, citation links, model configs, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** HTML, model weights, model configs, web pages, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, user data, comments, channel data, posts
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, author data, grant data, institution data, citation data, citation links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, arxiv, ArXiv, medRxiv, bioRxiv, arXiv, biorxiv, medrxiv, BioRxiv
...
- **Contains:** patent links, author data, grant data, citation data, paper metadata, venue data
- **Status:** VALUABLE, ACTIVE
