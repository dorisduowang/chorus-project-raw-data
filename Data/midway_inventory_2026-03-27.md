...
**Last Updated:** 2026-03-27T02:00:06.696142
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, MAG, OA, OpenAlex, Microsoft Academic Graph
...
- **Contains:** citation links, paper metadata, author data, model weights, model configs, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, HTML, web pages, model configs, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, paper metadata, patent links, author data, grant data, institution data, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medrxiv, BioRxiv, arxiv, bioRxiv, MedRxiv, biorxiv, ArXiv, medRxiv, arXiv
...
- **Contains:** paper metadata, patent links, author data, grant data, venue data, citation data
- **Status:** VALUABLE, ACTIVE
