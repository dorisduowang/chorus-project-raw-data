...
**Last Updated:** 2026-03-04T02:00:05.888568
...
- **Contains:** model configs, author data, citation links, institution data, paper metadata, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** HTML, model configs, text, model weights, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, grant data, author data, citation links, institution data, paper metadata, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medrxiv, MedRxiv, arXiv, medRxiv, ArXiv, BioRxiv, arxiv, bioRxiv, biorxiv
...
- **Contains:** patent links, grant data, venue data, author data, paper metadata, citation data
- **Status:** VALUABLE, ACTIVE
