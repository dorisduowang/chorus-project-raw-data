...
**Last Updated:** 2026-05-10T02:00:07.036754
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, MAG, OA, OpenAlex, Microsoft Academic
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation links, institution data, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** paper metadata, model weights, model configs, citation links, institution data, author data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** web pages, model weights, model configs, text, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, messages, channel data, posts, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation data, paper metadata, patent links, grant data, citation links, institution data, author data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** ArXiv, arxiv, BioRxiv, medRxiv, arXiv, biorxiv, MedRxiv, medrxiv, bioRxiv
...
- **Contains:** citation data, paper metadata, patent links, grant data, author data, venue data
- **Status:** VALUABLE, ACTIVE
