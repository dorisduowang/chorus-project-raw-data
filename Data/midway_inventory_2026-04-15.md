...
**Last Updated:** 2026-04-15T02:00:05.650786
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation data, patent links, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** author data, model configs, institution data, paper metadata, citation links, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model configs, text, web pages, HTML, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, grant data, institution data, paper metadata, citation links, citation data, patent links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, medrxiv, BioRxiv, MedRxiv, medRxiv, arxiv, arXiv, ArXiv, bioRxiv
...
- **Contains:** author data, grant data, paper metadata, citation data, patent links, venue data
- **Status:** VALUABLE, ACTIVE
