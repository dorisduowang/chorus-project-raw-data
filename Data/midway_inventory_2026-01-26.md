...
**Last Updated:** 2026-01-26T02:00:02.719937
...
### openalex-snapshot
- **Also known as:** MAG, Microsoft Academic Graph, OpenAlex, OA, Microsoft Academic
...
- **Contains:** model configs, model weights, HTML, text, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, channel data, user data, messages, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** institution data, paper metadata, citation data, author data, patent links, citation links, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, biorxiv, BioRxiv, bioRxiv, medRxiv, ArXiv, arxiv, medrxiv, arXiv
...
- **Contains:** paper metadata, citation data, author data, patent links, grant data, venue data
- **Status:** VALUABLE, ACTIVE
