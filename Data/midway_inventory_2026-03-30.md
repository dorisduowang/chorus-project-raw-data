...
**Last Updated:** 2026-03-30T02:00:02.162949
**Total Resources:** 136 directories
...
### openalex-snapshot
- **Also known as:** OA, OpenAlex, MAG, Microsoft Academic, Microsoft Academic Graph
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** grant data, citation data, patent links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model configs, institution data, citation links, model weights, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, messages, posts, comments, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** institution data, citation links, patent links, author data, citation data, grant data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** ArXiv, biorxiv, BioRxiv, arxiv, arXiv, medrxiv, medRxiv, MedRxiv, bioRxiv
...
- **Contains:** venue data, patent links, author data, citation data, grant data, paper metadata
- **Status:** VALUABLE, ACTIVE
