...
**Last Updated:** 2026-05-02T02:00:07.374955
...
- **Also known as:** S2, S2AG, Semantic Scholar, SemanticScholar
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, OA, OpenAlex, MAG, Microsoft Academic
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** paper metadata, institution data, citation links, author data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** author data, paper metadata, model weights, citation links, model configs, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, model configs, text, web pages, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, user data, comments, posts, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, author data, paper metadata, citation links, patent links, institution data, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, medRxiv, BioRxiv, medrxiv, ArXiv, MedRxiv, arxiv, bioRxiv, biorxiv
...
- **Contains:** grant data, author data, paper metadata, venue data, patent links, citation data
- **Status:** VALUABLE, ACTIVE
