...
**Last Updated:** 2026-05-05T02:00:07.014538
...
- **Also known as:** S2AG, SemanticScholar, S2, Semantic Scholar
...
### openalex-snapshot
- **Also known as:** OA, Microsoft Academic, MAG, Microsoft Academic Graph, OpenAlex
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** paper metadata, citation data, grant data, patent links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, institution data, author data, citation links, paper metadata, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, HTML, model configs, web pages, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, user data, posts, channel data, messages
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, patent links, institution data, author data, citation links, citation data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medRxiv, biorxiv, medrxiv, ArXiv, arXiv, bioRxiv, BioRxiv, MedRxiv, arxiv
...
- **Contains:** grant data, patent links, author data, citation data, paper metadata, venue data
- **Status:** VALUABLE, ACTIVE
