...
**Last Updated:** 2026-05-01T02:00:06.101335
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** institution data, citation links, paper metadata, author data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** citation links, model configs, model weights, paper metadata, institution data, author data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model configs, model weights, HTML, web pages, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, comments, posts, user data, messages
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, paper metadata, institution data, author data, citation data, grant data, patent links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medRxiv, biorxiv, BioRxiv, arXiv, ArXiv, arxiv, medrxiv, MedRxiv, bioRxiv
...
- **Contains:** paper metadata, author data, citation data, venue data, grant data, patent links
- **Status:** VALUABLE, ACTIVE
