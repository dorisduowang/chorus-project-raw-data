...
**Last Updated:** 2026-03-15T02:00:05.353186
**Total Resources:** 134 directories
...
- **Contains:** paper metadata, citation links, model weights, institution data, author data, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** HTML, model weights, text, web pages, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, posts, comments, messages, user data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, citation data, paper metadata, citation links, grant data, institution data, author data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** bioRxiv, arxiv, arXiv, medRxiv, ArXiv, MedRxiv, biorxiv, BioRxiv, medrxiv
...
- **Contains:** patent links, citation data, paper metadata, venue data, grant data, author data
- **Status:** VALUABLE, ACTIVE
