...
**Last Updated:** 2026-03-23T02:00:02.052298
...
### openalex-snapshot
- **Also known as:** OA, OpenAlex, Microsoft Academic, Microsoft Academic Graph, MAG
...
- **Contains:** model weights, model configs, author data, citation links, paper metadata, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, user data, messages, channel data, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation data, patent links, grant data, author data, citation links, paper metadata, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, arxiv, ArXiv, bioRxiv, biorxiv, medRxiv, MedRxiv, medrxiv, BioRxiv
...
- **Contains:** citation data, patent links, venue data, grant data, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
