...
**Last Updated:** 2026-01-17T02:00:03.526278
...
- **Contains:** institution data, model weights, citation links, model configs, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** institution data, grant data, citation links, author data, patent links, citation data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, bioRxiv, ArXiv, BioRxiv, medrxiv, MedRxiv, medRxiv, arxiv, biorxiv
...
- **Contains:** venue data, grant data, author data, patent links, citation data, paper metadata
- **Status:** VALUABLE, ACTIVE
