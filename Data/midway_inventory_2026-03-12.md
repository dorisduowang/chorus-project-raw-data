...
**Last Updated:** 2026-03-12T02:00:05.699662
...
- **Contains:** paper metadata, author data, model weights, citation links, model configs, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, posts, user data, channel data, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, grant data, citation data, author data, patent links, citation links, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medRxiv, biorxiv, arxiv, ArXiv, medrxiv, BioRxiv, arXiv, MedRxiv, bioRxiv
...
- **Contains:** paper metadata, grant data, citation data, author data, patent links, venue data
- **Status:** VALUABLE, ACTIVE
