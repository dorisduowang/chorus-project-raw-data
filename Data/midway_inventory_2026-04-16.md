...
**Last Updated:** 2026-04-16T02:00:06.061523
...
### openalex-snapshot
- **Also known as:** MAG, OpenAlex, Microsoft Academic Graph, Microsoft Academic, OA
...
- **Contains:** model weights, author data, institution data, paper metadata, model configs, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, web pages, HTML, text, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, user data, channel data, posts, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, institution data, patent links, citation data, grant data, paper metadata, citation links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, bioRxiv, arXiv, arxiv, medRxiv, BioRxiv, medrxiv, ArXiv, biorxiv
...
- **Contains:** patent links, author data, citation data, grant data, paper metadata, venue data
- **Status:** VALUABLE, ACTIVE
