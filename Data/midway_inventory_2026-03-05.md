...
**Last Updated:** 2026-03-05T02:00:06.993853
...
### openalex-snapshot
- **Also known as:** OA, MAG, Microsoft Academic, Microsoft Academic Graph, OpenAlex
...
- **Contains:** model weights, citation links, model configs, author data, institution data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, patent links, citation data, paper metadata, author data, institution data, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, arxiv, medRxiv, bioRxiv, BioRxiv, MedRxiv, biorxiv, ArXiv, medrxiv
...
- **Contains:** patent links, citation data, author data, grant data, venue data, paper metadata
- **Status:** VALUABLE, ACTIVE
