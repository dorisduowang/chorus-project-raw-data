...
**Last Updated:** 2026-03-29T02:00:06.738199
...
### openalex-snapshot
- **Also known as:** OA, Microsoft Academic, Microsoft Academic Graph, OpenAlex, MAG
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** institution data, paper metadata, citation links, author data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** institution data, model configs, author data, paper metadata, model weights, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, messages, comments, posts, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** institution data, patent links, author data, paper metadata, citation data, grant data, citation links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** bioRxiv, medRxiv, ArXiv, arxiv, arXiv, MedRxiv, biorxiv, BioRxiv, medrxiv
...
- **Contains:** patent links, author data, venue data, paper metadata, citation data, grant data
- **Status:** VALUABLE, ACTIVE
