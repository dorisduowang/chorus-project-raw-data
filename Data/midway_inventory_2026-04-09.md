...
**Last Updated:** 2026-04-09T02:00:02.097222
...
### openalex-snapshot
- **Also known as:** MAG, Microsoft Academic Graph, Microsoft Academic, OA, OpenAlex
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** author data, institution data, paper metadata, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** paper metadata, citation links, author data, institution data, model weights, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, HTML, model configs, text, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, channel data, comments, user data, messages
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, citation links, author data, institution data, patent links, grant data, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, BioRxiv, bioRxiv, arxiv, medrxiv, arXiv, medRxiv, ArXiv, MedRxiv
...
- **Contains:** paper metadata, patent links, author data, venue data, grant data, citation data
- **Status:** VALUABLE, ACTIVE
