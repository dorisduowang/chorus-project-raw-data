...
**Last Updated:** 2026-03-17T02:00:02.492783
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, channel data, posts, comments, user data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, author data, institution data, citation links, citation data, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** bioRxiv, MedRxiv, BioRxiv, ArXiv, biorxiv, arxiv, medrxiv, medRxiv, arXiv
...
- **Contains:** patent links, author data, citation data, venue data, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
