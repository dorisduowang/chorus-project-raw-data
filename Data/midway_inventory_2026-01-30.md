...
**Last Updated:** 2026-01-30T02:00:06.429419
**Total Resources:** 128 directories
...
- **Contains:** model configs, model weights, institution data, author data, paper metadata, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, user data, channel data, messages, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation data, grant data, patent links, institution data, author data, paper metadata, citation links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** BioRxiv, medrxiv, ArXiv, bioRxiv, medRxiv, MedRxiv, biorxiv, arxiv, arXiv
...
- **Contains:** citation data, grant data, venue data, patent links, paper metadata, author data
- **Status:** VALUABLE, ACTIVE
