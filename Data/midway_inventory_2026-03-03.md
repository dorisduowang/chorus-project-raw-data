...
**Last Updated:** 2026-03-03T02:00:02.829516
...
### openalex-snapshot
- **Also known as:** OpenAlex, OA, Microsoft Academic Graph, MAG, Microsoft Academic
...
- **Contains:** author data, institution data, model configs, citation links, model weights, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, web pages, model configs, model weights, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, institution data, grant data, citation data, citation links, patent links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** author data, grant data, citation data, venue data, patent links, paper metadata
- **Status:** VALUABLE, ACTIVE
