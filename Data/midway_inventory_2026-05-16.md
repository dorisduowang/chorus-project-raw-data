...
**Last Updated:** 2026-05-16T02:00:06.729424
...
### openalex-snapshot
- **Also known as:** OpenAlex, Microsoft Academic, Microsoft Academic Graph, OA, MAG
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** patent links, paper metadata, citation data, grant data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** comments, posts, user data
...
- **Contains:** model weights, paper metadata, author data, citation links, model configs, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, text, HTML, web pages, model configs
- **Status:** VALUABLE, ACTIVE
...
### Dawoon
- **Also known as:** OpenAlex, OA, Dimensions
- **Path:** `/project/jevans/Dawoon`
- **Owner:** jdwoon0523
- **Size:** 50-100 MB
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, paper metadata, author data, citation links, citation data, patent links, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, arXiv, ArXiv, medRxiv, bioRxiv, arxiv, biorxiv, BioRxiv, medrxiv
...
- **Contains:** grant data, venue data, paper metadata, author data, citation data, patent links
- **Status:** VALUABLE, ACTIVE
