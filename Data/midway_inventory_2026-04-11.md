...
**Last Updated:** 2026-04-11T02:00:04.965659
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, Microsoft Academic, OpenAlex, OA, MAG
...
- **Contains:** author data, citation links, model weights, model configs, paper metadata, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, posts, comments, channel data, user data
- **Status:** VALUABLE
...
### arxiv
- **Also known as:** ArXiv, arXiv, BioRxiv, MedRxiv, bioRxiv, medRxiv, biorxiv, arxiv, medrxiv
...
- **Contains:** author data, citation data, patent links, grant data, paper metadata, venue data
- **Status:** VALUABLE, ACTIVE
