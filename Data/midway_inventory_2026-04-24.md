...
**Last Updated:** 2026-04-24T02:00:10.838157
...
- **Also known as:** S2AG, Semantic Scholar, S2, SemanticScholar
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, OpenAlex, OA, MAG, Microsoft Academic
...
- **Contains:** paper metadata, author data, model weights, citation links, institution data, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** web pages, model weights, text, HTML, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, posts, comments, channel data, messages
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, author data, citation data, citation links, institution data, grant data, patent links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, bioRxiv, medRxiv, ArXiv, medrxiv, BioRxiv, MedRxiv, arXiv, arxiv
...
- **Contains:** paper metadata, author data, venue data, citation data, grant data, patent links
- **Status:** VALUABLE, ACTIVE
