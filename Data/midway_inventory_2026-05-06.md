...
**Last Updated:** 2026-05-06T02:00:06.085601
**Total Resources:** 143 directories
...
### openalex-snapshot
- **Also known as:** OA, Microsoft Academic Graph, MAG, OpenAlex, Microsoft Academic
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation links, institution data, paper metadata, author data
- **Status:** VALUABLE, ACTIVE
...
- **Also known as:** Microsoft Academic Graph, MAG, Microsoft Academic
...
- **Contains:** paper metadata, venue data, author data
- **Status:** VALUABLE, ACTIVE
...
- **Type:** Data Snapshot Directory
- **Contains:** citation metrics, impact scores, grant linkages
- **Status:** VALUABLE
...
- **Type:** Major Data Snapshot Directory
- **Contains:** knowledge graph, grant-paper links, entity linkages
- **Status:** VALUABLE
...
- **Contains:** user data, comments, posts
...
### PwC_Mar_04_2025
- **Also known as:** PapersWithCode, PwC, Papers with Code
...
- **Contains:** model weights, author data, citation links, institution data, paper metadata, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, web pages, text, HTML, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, comments, messages, posts, channel data
- **Status:** VALUABLE
...
### Dawoon
- **Also known as:** OA, OpenAlex, Dimensions
- **Path:** `/project/jevans/Dawoon`
- **Owner:** jdwoon0523
- **Size:** 50-100 MB
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, author data, patent links, citation data, citation links, institution data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, BioRxiv, medRxiv, bioRxiv, medrxiv, ArXiv, MedRxiv, arxiv, biorxiv
- **Path:** `/project/jevans/arxiv`
- **Owner:** jsourati
- **Size:** 4 GB
- **Category:** Preprint Server Data
- **Type:** Data Snapshot Directory
- **Contains:** categories, preprint metadata, abstracts
- **Status:** VALUABLE
...
- **Contains:** grant data, venue data, author data, patent links, citation data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### llm_creativity
- **Path:** `/project/jevans/llm_creativity`
- **Owner:** zehan
- **Size:** 0.0 MB
- **Last Modified:** 2026-05-01
