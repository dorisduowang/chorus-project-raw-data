...
**Last Updated:** 2026-03-18T02:00:05.491437
...
- **Contains:** model weights, citation links, model configs, institution data, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, citation data, patent links, institution data, author data, grant data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, medrxiv, arXiv, BioRxiv, medRxiv, arxiv, biorxiv, ArXiv, bioRxiv
...
- **Contains:** citation data, patent links, author data, grant data, venue data, paper metadata
- **Status:** VALUABLE, ACTIVE
