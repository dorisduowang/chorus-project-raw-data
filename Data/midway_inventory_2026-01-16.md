...
**Last Updated:** 2026-01-16T02:00:05.653288
...
**Bibliographic Database:** semantic_scholar_Jan31_2025, S2AG_Dec_2024_snapshot, openalex-snapshot, dimensions, openalex-snapshot_old
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, Microsoft Academic, OpenAlex, MAG, OA
...
- **Contains:** author data, paper metadata, institution data, citation links, model configs, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, comments, user data, messages, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, patent links, paper metadata, institution data, grant data, citation links, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, medrxiv, arXiv, arxiv, ArXiv, bioRxiv, BioRxiv, biorxiv, medRxiv
...
- **Contains:** author data, patent links, paper metadata, grant data, citation data, venue data
- **Status:** VALUABLE, ACTIVE
