...
**Last Updated:** 2026-03-08T03:00:02.056545
...
- **Contains:** institution data, model configs, author data, model weights, citation links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model configs, web pages, model weights, text, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, channel data, messages, posts, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation data, institution data, patent links, author data, grant data, citation links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, MedRxiv, ArXiv, medrxiv, arXiv, medRxiv, arxiv, bioRxiv, BioRxiv
