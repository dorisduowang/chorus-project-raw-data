...
**Last Updated:** 2026-05-17T02:00:09.801987
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, OpenAlex, MAG, OA, Microsoft Academic Graph
...
- **Contains:** model configs, citation links, model weights, institution data, paper metadata, author data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** web pages, model configs, text, model weights, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, channel data, posts, user data, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, patent links, grant data, citation data, institution data, paper metadata, author data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arxiv, MedRxiv, BioRxiv, ArXiv, medRxiv, arXiv, biorxiv, bioRxiv, medrxiv
...
- **Contains:** patent links, grant data, citation data, venue data, paper metadata, author data
- **Status:** VALUABLE, ACTIVE
