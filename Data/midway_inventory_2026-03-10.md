...
**Last Updated:** 2026-03-10T02:00:06.608553
...
- **Contains:** author data, model configs, model weights, institution data, citation links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, model configs, HTML, model weights, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, patent links, grant data, institution data, citation data, citation links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** BioRxiv, bioRxiv, medRxiv, medrxiv, ArXiv, arxiv, MedRxiv, biorxiv, arXiv
...
- **Contains:** author data, patent links, venue data, grant data, citation data, paper metadata
- **Status:** VALUABLE, ACTIVE
