...
**Last Updated:** 2026-04-30T02:00:06.235006
...
### openalex-snapshot
- **Also known as:** OA, Microsoft Academic, OpenAlex, MAG, Microsoft Academic Graph
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** paper metadata, citation links, institution data, author data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** paper metadata, grant data, patent links, citation data
- **Status:** VALUABLE, ACTIVE
...
- **Type:** Major Data Snapshot Directory
- **Contains:** grant-paper links, knowledge graph, entity linkages
- **Status:** VALUABLE
...
- **Contains:** user data, posts, comments
...
- **Contains:** paper metadata, citation links, model weights, model configs, author data, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** HTML, model weights, text, model configs, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, posts, comments, user data, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, paper metadata, grant data, citation links, author data, institution data, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, ArXiv, medRxiv, medrxiv, BioRxiv, biorxiv, bioRxiv, arXiv, arxiv
...
- **Contains:** patent links, paper metadata, grant data, venue data, author data, citation data
- **Status:** VALUABLE, ACTIVE
