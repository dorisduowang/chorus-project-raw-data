...
**Last Updated:** 2026-01-21T02:00:05.730304
...
### openalex-snapshot
- **Also known as:** MAG, Microsoft Academic, OA, OpenAlex, Microsoft Academic Graph
...
- **Contains:** institution data, paper metadata, model weights, author data, citation links, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, text, web pages, HTML, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, posts, channel data, messages, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation data, institution data, paper metadata, author data, citation links, grant data, patent links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medRxiv, medrxiv, arXiv, biorxiv, bioRxiv, MedRxiv, BioRxiv, ArXiv, arxiv
...
- **Contains:** venue data, citation data, paper metadata, author data, grant data, patent links
- **Status:** VALUABLE, ACTIVE
