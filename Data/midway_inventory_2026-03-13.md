...
**Last Updated:** 2026-03-13T02:00:02.782983
...
### openalex-snapshot
- **Also known as:** MAG, Microsoft Academic Graph, OpenAlex, Microsoft Academic, OA
...
- **Contains:** model configs, paper metadata, citation links, institution data, author data, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, HTML, web pages, model configs, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, comments, messages, channel data, user data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, paper metadata, citation links, institution data, author data, citation data, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, medRxiv, arxiv, bioRxiv, BioRxiv, arXiv, medrxiv, ArXiv, biorxiv
...
- **Contains:** patent links, paper metadata, venue data, author data, citation data, grant data
- **Status:** VALUABLE, ACTIVE
