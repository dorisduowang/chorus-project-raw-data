...
**Last Updated:** 2026-03-25T02:00:07.537110
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, OA, Microsoft Academic, OpenAlex, MAG
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** paper metadata, citation data, patent links, grant data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** author data, institution data, paper metadata, model weights, citation links, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** HTML, web pages, model weights, text, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, messages, user data, comments, posts
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation data, author data, grant data, institution data, paper metadata, citation links, patent links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** bioRxiv, ArXiv, arxiv, MedRxiv, BioRxiv, biorxiv, medRxiv, medrxiv, arXiv
...
- **Contains:** citation data, author data, venue data, grant data, paper metadata, patent links
- **Status:** VALUABLE, ACTIVE
