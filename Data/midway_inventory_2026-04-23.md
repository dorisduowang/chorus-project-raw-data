...
**Last Updated:** 2026-04-23T02:00:06.395757
...
### openalex-snapshot
- **Also known as:** MAG, Microsoft Academic Graph, OA, OpenAlex, Microsoft Academic
...
- **Contains:** citation links, model weights, paper metadata, institution data, model configs, author data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, HTML, text, model configs, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, comments, user data, posts, messages
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, grant data, patent links, paper metadata, institution data, citation data, author data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, bioRxiv, biorxiv, BioRxiv, arxiv, medRxiv, medrxiv, ArXiv, MedRxiv
