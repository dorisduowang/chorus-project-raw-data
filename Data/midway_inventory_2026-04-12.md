...
**Last Updated:** 2026-04-12T02:00:23.781001
...
### openalex-snapshot
- **Also known as:** OA, Microsoft Academic, MAG, OpenAlex, Microsoft Academic Graph
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** institution data, author data, paper metadata, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** citation links, author data, paper metadata, institution data, model weights, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** web pages, text, HTML, model weights, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, posts, channel data, user data, messages
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, author data, paper metadata, citation data, patent links, institution data, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arxiv, bioRxiv, ArXiv, MedRxiv, arXiv, medRxiv, BioRxiv, biorxiv, medrxiv
...
- **Contains:** author data, paper metadata, citation data, patent links, grant data, venue data
- **Status:** VALUABLE, ACTIVE
