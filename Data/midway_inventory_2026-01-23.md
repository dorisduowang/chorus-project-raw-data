...
**Last Updated:** 2026-01-23T02:00:04.369631
...
- **Contains:** model configs, paper metadata, model weights, citation links, author data, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model configs, HTML, model weights, text, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, user data, posts, channel data, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, paper metadata, citation links, author data, citation data, patent links, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arxiv, ArXiv, MedRxiv, medRxiv, medrxiv, bioRxiv, arXiv, biorxiv, BioRxiv
...
- **Contains:** grant data, paper metadata, author data, citation data, patent links, venue data
- **Status:** VALUABLE, ACTIVE
