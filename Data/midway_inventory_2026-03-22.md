...
**Last Updated:** 2026-03-22T02:00:04.921930
**Total Resources:** 135 directories
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, MAG, OpenAlex, OA, Microsoft Academic
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** institution data, author data, citation links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** author data, citation links, paper metadata, model weights, model configs, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, user data, posts, messages, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, citation data, citation links, paper metadata, patent links, institution data, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arxiv, medRxiv, MedRxiv, biorxiv, ArXiv, BioRxiv, arXiv, bioRxiv, medrxiv
...
- **Contains:** author data, citation data, patent links, paper metadata, venue data, grant data
- **Status:** VALUABLE, ACTIVE
