...
**Last Updated:** 2026-04-20T02:00:03.971325
...
- **Also known as:** S2, Semantic Scholar, SemanticScholar, S2AG
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, OpenAlex, OA, Microsoft Academic Graph, MAG
...
- **Contains:** preprint metadata, abstracts, HTML data
...
- **Contains:** model weights, institution data, author data, citation links, model configs, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, model configs, HTML, web pages, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, messages, posts, channel data, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** institution data, author data, citation links, patent links, citation data, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, MedRxiv, medRxiv, arxiv, BioRxiv, ArXiv, medrxiv, arXiv, bioRxiv
...
- **Contains:** venue data, author data, patent links, citation data, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
