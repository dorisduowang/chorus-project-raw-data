...
**Last Updated:** 2026-05-08T02:00:06.915180
...
- **Also known as:** Semantic Scholar, SemanticScholar, S2, S2AG
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, Microsoft Academic, OA, MAG, OpenAlex
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** author data, citation links, institution data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation data, grant data, patent links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** author data, venue data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** author data, citation links, institution data, model configs, model weights, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, HTML, model configs, web pages, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, channel data, messages, user data, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, citation links, institution data, grant data, patent links, citation data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arxiv, MedRxiv, medRxiv, ArXiv, medrxiv, bioRxiv, biorxiv, arXiv, BioRxiv
...
- **Contains:** author data, grant data, patent links, citation data, venue data, paper metadata
- **Status:** VALUABLE, ACTIVE
