...
**Last Updated:** 2026-03-16T02:00:02.316181
...
### openalex-snapshot
- **Also known as:** OpenAlex, Microsoft Academic Graph, OA, MAG, Microsoft Academic
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** patent links, paper metadata, grant data, citation data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** citation links, author data, model configs, model weights, institution data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** web pages, model configs, model weights, HTML, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, messages, channel data, posts, user data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, citation data, citation links, author data, institution data, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arxiv, bioRxiv, arXiv, medrxiv, BioRxiv, ArXiv, medRxiv, biorxiv, MedRxiv
...
- **Contains:** patent links, citation data, author data, venue data, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
