...
**Last Updated:** 2026-03-24T02:00:07.703068
...
- **Contains:** HTML, web pages, text, model weights, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, messages, posts, user data, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** institution data, grant data, citation links, citation data, author data, patent links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** BioRxiv, medrxiv, ArXiv, medRxiv, arXiv, arxiv, biorxiv, MedRxiv, bioRxiv
...
- **Contains:** grant data, venue data, citation data, author data, patent links, paper metadata
- **Status:** VALUABLE, ACTIVE
