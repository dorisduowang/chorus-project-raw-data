...
**Last Updated:** 2026-01-31T02:00:05.552852
...
### openalex-snapshot
- **Also known as:** OpenAlex, OA, MAG, Microsoft Academic Graph, Microsoft Academic
...
- **Contains:** model configs, author data, citation links, institution data, model weights, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model configs, HTML, web pages, text, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, user data, posts, comments, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, citation links, citation data, patent links, institution data, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medRxiv, MedRxiv, arXiv, bioRxiv, BioRxiv, biorxiv, ArXiv, arxiv, medrxiv
...
- **Contains:** author data, venue data, citation data, patent links, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
