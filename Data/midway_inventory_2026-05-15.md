...
**Last Updated:** 2026-05-15T02:00:06.205797
...
### openalex-snapshot
- **Also known as:** MAG, OA, Microsoft Academic Graph, Microsoft Academic, OpenAlex
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation links, author data, paper metadata, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** citation links, model weights, institution data, author data, paper metadata, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, model weights, HTML, model configs, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, comments, messages, user data, posts
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, patent links, citation data, institution data, grant data, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** BioRxiv, arxiv, biorxiv, bioRxiv, arXiv, MedRxiv, medRxiv, medrxiv, ArXiv
...
- **Contains:** venue data, patent links, citation data, grant data, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
