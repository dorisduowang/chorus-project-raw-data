...
**Last Updated:** 2026-01-29T02:00:06.170941
...
### openalex-snapshot
- **Also known as:** OpenAlex, Microsoft Academic, MAG, OA, Microsoft Academic Graph
...
- **Contains:** model weights, citation links, author data, paper metadata, institution data, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, messages, posts, user data, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, author data, patent links, paper metadata, citation data, institution data, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medrxiv, biorxiv, medRxiv, MedRxiv, arXiv, BioRxiv, arxiv, ArXiv, bioRxiv
...
- **Contains:** author data, patent links, paper metadata, citation data, venue data, grant data
- **Status:** VALUABLE, ACTIVE
