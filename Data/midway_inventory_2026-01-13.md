...
**Last Updated:** 2026-01-13T21:23:40.267185
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, OpenAlex, Microsoft Academic Graph, OA, MAG
...
- **Contains:** author data, institution data, model weights, paper metadata, model configs, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** web pages, model weights, HTML, text, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, patent links, citation data, institution data, grant data, paper metadata, citation links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** bioRxiv, medRxiv, BioRxiv, MedRxiv, arXiv, ArXiv, biorxiv, medrxiv, arxiv
...
- **Contains:** author data, patent links, citation data, venue data, grant data, paper metadata
- **Status:** VALUABLE, ACTIVE
