...
**Last Updated:** 2026-04-22T02:00:12.361114
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, OA, MAG, Microsoft Academic, OpenAlex
...
- **Contains:** paper metadata, author data, model configs, citation links, institution data, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, messages, channel data, user data, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, author data, citation links, institution data, patent links, citation data, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, BioRxiv, arxiv, medrxiv, MedRxiv, biorxiv, bioRxiv, ArXiv, medRxiv
...
- **Contains:** paper metadata, author data, patent links, citation data, venue data, grant data
- **Status:** VALUABLE, ACTIVE
