...
**Last Updated:** 2026-04-13T02:00:05.770772
**Total Resources:** 140 directories
...
- **Also known as:** S2, Semantic Scholar, S2AG, SemanticScholar
...
### openalex-snapshot
- **Also known as:** MAG, OA, Microsoft Academic Graph, OpenAlex, Microsoft Academic
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** author data, paper metadata, institution data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** grant data, patent links, paper metadata, citation data
- **Status:** VALUABLE, ACTIVE
...
- **Also known as:** MAG, Microsoft Academic, Microsoft Academic Graph
...
- **Contains:** model weights, model configs, citation links, institution data, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, web pages, HTML, model configs, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, messages, channel data, comments, user data
- **Status:** VALUABLE
...
### Dawoon
- **Also known as:** Dimensions, OA, OpenAlex
- **Path:** `/project/jevans/Dawoon`
- **Owner:** jdwoon0523
- **Size:** 50-100 MB
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation data, patent links, citation links, institution data, author data, grant data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, bioRxiv, arxiv, biorxiv, medRxiv, BioRxiv, medrxiv, ArXiv, MedRxiv
- **Path:** `/project/jevans/arxiv`
- **Owner:** jsourati
- **Size:** 4 GB
- **Category:** Preprint Server Data
- **Type:** Data Snapshot Directory
- **Contains:** preprint metadata, categories, abstracts
- **Status:** VALUABLE
...
- **Contains:** citation data, patent links, venue data, author data, grant data, paper metadata
- **Status:** VALUABLE, ACTIVE
