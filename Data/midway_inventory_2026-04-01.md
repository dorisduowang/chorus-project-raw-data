...
**Last Updated:** 2026-04-01T02:00:05.844833
...
- **Contains:** paper metadata, model weights, author data, citation links, model configs, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, grant data, author data, patent links, citation links, citation data, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arxiv, BioRxiv, medrxiv, ArXiv, arXiv, bioRxiv, MedRxiv, biorxiv, medRxiv
...
- **Contains:** paper metadata, grant data, author data, patent links, citation data, venue data
- **Status:** VALUABLE, ACTIVE
