...
**Last Updated:** 2026-04-19T02:00:06.413278
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, MAG, OA, Microsoft Academic Graph, OpenAlex
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** paper metadata, citation links, author data, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation data, paper metadata, patent links, grant data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** paper metadata, author data, model weights, institution data, citation links, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** web pages, HTML, model weights, model configs, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, patent links, author data, institution data, grant data, citation links, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, medRxiv, bioRxiv, biorxiv, arXiv, medrxiv, ArXiv, BioRxiv, arxiv
...
- **Contains:** venue data, paper metadata, patent links, author data, grant data, citation data
- **Status:** VALUABLE, ACTIVE
