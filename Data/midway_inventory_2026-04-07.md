...
**Last Updated:** 2026-04-07T02:00:04.467988
**Total Resources:** 139 directories
...
- **Also known as:** Semantic Scholar, S2, SemanticScholar, S2AG
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, OpenAlex, Microsoft Academic Graph, MAG, OA
...
- **Contains:** citation links, model configs, author data, institution data, paper metadata, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** web pages, model configs, text, HTML, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, messages, user data, posts, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, patent links, author data, institution data, grant data, paper metadata, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medrxiv, medRxiv, BioRxiv, MedRxiv, bioRxiv, ArXiv, biorxiv, arxiv, arXiv
...
- **Contains:** patent links, author data, grant data, venue data, paper metadata, citation data
- **Status:** VALUABLE, ACTIVE
