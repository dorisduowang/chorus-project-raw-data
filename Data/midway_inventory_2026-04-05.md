...
**Last Updated:** 2026-04-05T02:00:05.437835
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, MAG, OA, Microsoft Academic, OpenAlex
...
- **Contains:** paper metadata, citation links, author data, institution data, model configs, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, messages, user data, comments, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation data, paper metadata, citation links, author data, institution data, patent links, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, medRxiv, arXiv, arxiv, medrxiv, ArXiv, bioRxiv, MedRxiv, BioRxiv
...
- **Contains:** citation data, paper metadata, author data, venue data, patent links, grant data
- **Status:** VALUABLE, ACTIVE
