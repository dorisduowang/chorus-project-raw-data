...
**Last Updated:** 2026-01-25T02:00:05.315230
...
- **Contains:** model weights, model configs, institution data, paper metadata, citation links, author data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, citation data, institution data, paper metadata, citation links, grant data, author data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** ArXiv, medRxiv, medrxiv, biorxiv, arXiv, BioRxiv, bioRxiv, MedRxiv, arxiv
...
- **Contains:** patent links, citation data, paper metadata, grant data, venue data, author data
- **Status:** VALUABLE, ACTIVE
