...
**Last Updated:** 2026-05-14T02:00:07.179377
...
- **Also known as:** Semantic Scholar, S2AG, S2, SemanticScholar
...
### openalex-snapshot
- **Also known as:** MAG, Microsoft Academic, OpenAlex, OA, Microsoft Academic Graph
...
- **Contains:** model weights, citation links, author data, paper metadata, model configs, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, model configs, web pages, text, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, author data, grant data, paper metadata, citation data, institution data, patent links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medrxiv, ArXiv, MedRxiv, arXiv, biorxiv, BioRxiv, arxiv, medRxiv, bioRxiv
...
- **Contains:** author data, grant data, paper metadata, citation data, venue data, patent links
- **Status:** VALUABLE, ACTIVE
