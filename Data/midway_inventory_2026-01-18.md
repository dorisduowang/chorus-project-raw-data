...
**Last Updated:** 2026-01-18T02:00:03.019035
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, OA, Microsoft Academic Graph, OpenAlex, MAG
...
- **Contains:** paper metadata, model weights, citation links, model configs, institution data, author data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, posts, user data, messages, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, citation data, patent links, citation links, grant data, institution data, author data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medRxiv, biorxiv, bioRxiv, BioRxiv, MedRxiv, ArXiv, arxiv, arXiv, medrxiv
...
- **Contains:** paper metadata, citation data, patent links, grant data, venue data, author data
- **Status:** VALUABLE, ACTIVE
