...
**Last Updated:** 2026-03-26T02:00:04.875227
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, comments, user data, channel data, posts
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, author data, patent links, grant data, institution data, citation links, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medRxiv, arXiv, ArXiv, bioRxiv, biorxiv, BioRxiv, MedRxiv, medrxiv, arxiv
...
- **Contains:** paper metadata, author data, patent links, grant data, citation data, venue data
- **Status:** VALUABLE, ACTIVE
