...
**Last Updated:** 2026-03-19T02:00:05.512545
...
### openalex-snapshot
- **Also known as:** OA, OpenAlex, Microsoft Academic Graph, Microsoft Academic, MAG
...
- **Contains:** citation links, institution data, author data, paper metadata, model configs, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model configs, web pages, HTML, model weights, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, comments, posts, messages, user data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, citation data, institution data, author data, paper metadata, patent links, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, arxiv, medrxiv, bioRxiv, ArXiv, BioRxiv, MedRxiv, medRxiv, arXiv
...
- **Contains:** venue data, citation data, author data, paper metadata, patent links, grant data
- **Status:** VALUABLE, ACTIVE
