...
**Last Updated:** 2026-04-26T02:00:05.615897
...
### openalex-snapshot
- **Also known as:** OpenAlex, OA, Microsoft Academic, MAG, Microsoft Academic Graph
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** author data, citation links, paper metadata, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** grant data, citation data, paper metadata, patent links
- **Status:** VALUABLE, ACTIVE
...
- **Also known as:** Microsoft Academic, Microsoft Academic Graph, MAG
...
- **Contains:** venue data, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Type:** Major Data Snapshot Directory
- **Contains:** patent bibliographic data, patent citations, legal status
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** abstracts, HTML data, preprint metadata
...
- **Type:** Major Data Snapshot Directory
- **Contains:** grant-paper links, entity linkages, knowledge graph
- **Status:** VALUABLE
...
### PwC_Mar_04_2025
- **Also known as:** PapersWithCode, Papers with Code, PwC
...
- **Contains:** model weights, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model configs, author data, citation links, model weights, paper metadata, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, channel data, user data, messages, posts
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, citation links, citation data, patent links, grant data, paper metadata, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arxiv, MedRxiv, bioRxiv, medRxiv, BioRxiv, ArXiv, arXiv, biorxiv, medrxiv
- **Path:** `/project/jevans/arxiv`
- **Owner:** jsourati
- **Size:** 4 GB
- **Category:** Preprint Server Data
- **Type:** Data Snapshot Directory
- **Contains:** abstracts, categories, preprint metadata
- **Status:** VALUABLE
...
### donghyun
- **Also known as:** Dimensions, dblp, DBLP
- **Path:** `/project/jevans/donghyun`
- **Owner:** kangd
- **Size:** 1-5 GB
- **Category:** Computer Science Bibliography
- **Type:** Individual Researcher Directory - Extensive Projects
- **Contains:** author data, citation data, grant data, venue data, paper metadata, patent links
- **Status:** VALUABLE, ACTIVE
