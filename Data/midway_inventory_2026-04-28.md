...
**Last Updated:** 2026-04-28T02:00:05.993755
...
- **Also known as:** S2AG, SemanticScholar, Semantic Scholar, S2
...
### openalex-snapshot
- **Also known as:** OpenAlex, MAG, Microsoft Academic, Microsoft Academic Graph, OA
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation links, paper metadata, institution data, author data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** grant data, paper metadata, citation data, patent links
- **Status:** VALUABLE, ACTIVE
...
- **Type:** Major Data Snapshot Directory
- **Contains:** patent citations, legal status, patent bibliographic data
- **Status:** VALUABLE, ACTIVE
...
- **Type:** Data Snapshot Directory
- **Contains:** grant linkages, citation metrics, impact scores
- **Status:** VALUABLE
...
- **Contains:** citation links, paper metadata, model configs, author data, institution data, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** web pages, text, model configs, HTML, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, messages, comments, posts, user data
- **Status:** VALUABLE
...
### Dawoon
- **Also known as:** OpenAlex, Dimensions, OA
- **Path:** `/project/jevans/Dawoon`
- **Owner:** jdwoon0523
- **Size:** 50-100 MB
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, patent links, citation links, paper metadata, citation data, author data, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, BioRxiv, arXiv, medRxiv, arxiv, biorxiv, ArXiv, bioRxiv, medrxiv
...
- **Contains:** grant data, patent links, paper metadata, venue data, citation data, author data
- **Status:** VALUABLE, ACTIVE
