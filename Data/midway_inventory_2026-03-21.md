...
**Last Updated:** 2026-03-21T02:00:05.687113
...
- **Contains:** institution data, model weights, model configs, paper metadata, author data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, posts, messages, channel data, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, citation data, institution data, patent links, paper metadata, author data, citation links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, arxiv, ArXiv, medRxiv, bioRxiv, BioRxiv, MedRxiv, medrxiv, biorxiv
...
- **Contains:** grant data, citation data, patent links, paper metadata, venue data, author data
- **Status:** VALUABLE, ACTIVE
