...
**Last Updated:** 2026-04-06T02:00:06.557257
...
### openalex-snapshot
- **Also known as:** OA, MAG, OpenAlex, Microsoft Academic Graph, Microsoft Academic
...
- **Contains:** paper metadata, author data, model weights, model configs, institution data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** web pages, HTML, text, model weights, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, author data, patent links, institution data, citation links, grant data, citation data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, biorxiv, ArXiv, arxiv, medrxiv, bioRxiv, BioRxiv, arXiv, medRxiv
...
- **Contains:** venue data, paper metadata, author data, patent links, grant data, citation data
- **Status:** VALUABLE, ACTIVE
