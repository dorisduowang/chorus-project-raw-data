...
**Last Updated:** 2026-03-02T02:00:05.605049
...
- **Contains:** model weights, web pages, model configs, HTML, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, posts, messages, user data, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, grant data, paper metadata, citation data, patent links, institution data, author data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, medRxiv, arxiv, biorxiv, medrxiv, BioRxiv, bioRxiv, ArXiv, MedRxiv
...
- **Contains:** grant data, paper metadata, citation data, patent links, venue data, author data
- **Status:** VALUABLE, ACTIVE
