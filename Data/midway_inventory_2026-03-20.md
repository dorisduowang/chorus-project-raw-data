...
**Last Updated:** 2026-03-20T02:00:06.653675
...
- **Contains:** author data, model weights, model configs, institution data, paper metadata, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, author data, citation data, institution data, patent links, paper metadata, citation links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, BioRxiv, MedRxiv, arXiv, arxiv, medRxiv, medrxiv, bioRxiv, ArXiv
...
- **Contains:** grant data, author data, citation data, patent links, paper metadata, venue data
- **Status:** VALUABLE, ACTIVE
