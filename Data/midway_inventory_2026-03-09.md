...
**Last Updated:** 2026-03-09T02:00:07.527292
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, Microsoft Academic Graph, MAG, OpenAlex, OA
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** institution data, citation links, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** paper metadata, model configs, model weights, author data, citation links, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation data, paper metadata, author data, citation links, grant data, patent links, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medrxiv, arXiv, arxiv, BioRxiv, MedRxiv, biorxiv, medRxiv, bioRxiv, ArXiv
...
- **Contains:** citation data, venue data, paper metadata, author data, grant data, patent links
- **Status:** VALUABLE, ACTIVE
