...
**Last Updated:** 2026-04-21T02:00:03.389231
...
### openalex-snapshot
- **Also known as:** OA, Microsoft Academic Graph, Microsoft Academic, MAG, OpenAlex
...
- **Contains:** institution data, model configs, model weights, author data, citation links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, web pages, HTML, model configs, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, comments, messages, channel data, posts
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, citation data, patent links, institution data, author data, citation links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, bioRxiv, BioRxiv, biorxiv, arXiv, medRxiv, arxiv, ArXiv, medrxiv
...
- **Contains:** grant data, citation data, venue data, patent links, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
