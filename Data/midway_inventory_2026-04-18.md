...
**Last Updated:** 2026-04-18T02:00:07.251931
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** institution data, paper metadata, author data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation data, paper metadata, grant data, patent links
- **Status:** VALUABLE, ACTIVE
...
- **Type:** Major Data Snapshot Directory
- **Contains:** entity linkages, knowledge graph, grant-paper links
- **Status:** VALUABLE
...
- **Contains:** model configs, institution data, paper metadata, model weights, author data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** HTML, model configs, web pages, model weights, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, channel data, comments, messages, user data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation data, grant data, patent links, institution data, paper metadata, author data, citation links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** ArXiv, BioRxiv, bioRxiv, MedRxiv, arXiv, biorxiv, medRxiv, arxiv, medrxiv
- **Path:** `/project/jevans/arxiv`
- **Owner:** jsourati
- **Size:** 4 GB
- **Category:** Preprint Server Data
- **Type:** Data Snapshot Directory
- **Contains:** categories, abstracts, preprint metadata
- **Status:** VALUABLE
...
- **Contains:** citation data, grant data, patent links, venue data, paper metadata, author data
- **Status:** VALUABLE, ACTIVE
