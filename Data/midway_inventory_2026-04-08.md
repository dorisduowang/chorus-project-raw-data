...
**Last Updated:** 2026-04-08T02:00:07.121904
...
**Other Data:** corpora, Dawoon_APTO_Data, Dawoon_APTO_data
...
- **Also known as:** SemanticScholar, S2, Semantic Scholar, S2AG
...
### openalex-snapshot
- **Also known as:** OA, Microsoft Academic, OpenAlex, Microsoft Academic Graph, MAG
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation data, patent links, grant data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** institution data, author data, model configs, paper metadata, citation links, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, model configs, HTML, web pages, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, comments, posts, channel data, user data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** institution data, author data, paper metadata, citation links, citation data, patent links, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, bioRxiv, biorxiv, medRxiv, BioRxiv, ArXiv, arxiv, medrxiv, arXiv
...
- **Contains:** author data, paper metadata, citation data, venue data, patent links, grant data
- **Status:** VALUABLE, ACTIVE
