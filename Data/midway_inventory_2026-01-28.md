...
**Last Updated:** 2026-01-28T02:00:02.134156
...
### openalex-snapshot
- **Also known as:** MAG, Microsoft Academic Graph, Microsoft Academic, OpenAlex, OA
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** paper metadata, author data, institution data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** paper metadata, citation links, model configs, author data, model weights, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, user data, messages, channel data, posts
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, citation links, citation data, author data, grant data, paper metadata, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** bioRxiv, MedRxiv, biorxiv, ArXiv, BioRxiv, medRxiv, medrxiv, arxiv, arXiv
...
- **Contains:** venue data, patent links, citation data, author data, grant data, paper metadata
- **Status:** VALUABLE, ACTIVE
