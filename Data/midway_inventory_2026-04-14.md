...
**Last Updated:** 2026-04-14T02:00:06.567041
**Total Resources:** 141 directories
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, OpenAlex, MAG, Microsoft Academic, OA
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** author data, paper metadata, citation links, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** grant data, paper metadata, patent links, citation data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** author data, paper metadata, venue data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** preprint metadata, HTML data, abstracts
...
- **Type:** Data Snapshot Directory
- **Contains:** impact scores, grant linkages, citation metrics
- **Status:** VALUABLE
...
- **Contains:** posts, user data, comments
...
### PwC_Mar_04_2025
- **Also known as:** PwC, Papers with Code, PapersWithCode
...
- **Contains:** author data, paper metadata, model weights, model configs, citation links, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** HTML, web pages, model weights, model configs, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, messages, user data, posts, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, paper metadata, citation data, grant data, patent links, citation links, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medRxiv, arxiv, medrxiv, MedRxiv, bioRxiv, biorxiv, arXiv, BioRxiv, ArXiv
...
- **Contains:** author data, paper metadata, grant data, venue data, patent links, citation data
- **Status:** VALUABLE, ACTIVE
