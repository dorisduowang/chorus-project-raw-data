...
**Last Updated:** 2026-03-07T02:00:09.308548
**Total Resources:** 132 directories
...
- **Also known as:** SemanticScholar, S2, S2AG, Semantic Scholar
...
- **Contains:** model configs, model weights, institution data, paper metadata, author data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, user data, channel data, comments, posts
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, institution data, patent links, citation data, paper metadata, author data, citation links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, MedRxiv, BioRxiv, arxiv, medrxiv, arXiv, bioRxiv, medRxiv, ArXiv
...
- **Contains:** grant data, venue data, patent links, citation data, paper metadata, author data
- **Status:** VALUABLE, ACTIVE
