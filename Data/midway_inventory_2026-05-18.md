...
**Last Updated:** 2026-05-18T02:00:06.487547
**Total Resources:** 144 directories
...
- **Also known as:** S2, SemanticScholar, S2AG, Semantic Scholar
...
### openalex-snapshot
- **Also known as:** OpenAlex, MAG, Microsoft Academic Graph, Microsoft Academic, OA
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** author data, institution data, citation links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Also known as:** Microsoft Academic Graph, Microsoft Academic, MAG
...
- **Type:** Data Snapshot Directory
- **Contains:** impact scores, citation metrics, grant linkages
- **Status:** VALUABLE
...
- **Contains:** paper metadata, model weights, institution data, model configs, author data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, model weights, model configs, HTML, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, posts, user data, comments, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, institution data, patent links, citation data, author data, grant data, citation links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medRxiv, arXiv, MedRxiv, BioRxiv, ArXiv, bioRxiv, arxiv, biorxiv, medrxiv
...
- **Contains:** paper metadata, patent links, citation data, author data, venue data, grant data
- **Status:** VALUABLE, ACTIVE
...
- `chorus` (owner: tzhang3, path: `/project/jevans/chorus`)
