...
**Last Updated:** 2026-05-09T02:00:05.012865
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, MAG, OpenAlex, Microsoft Academic Graph, OA
...
- **Contains:** model weights, model configs, paper metadata, author data, citation links, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, text, HTML, model configs, web pages
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, patent links, citation data, paper metadata, author data, citation links, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** bioRxiv, medrxiv, BioRxiv, arxiv, MedRxiv, arXiv, ArXiv, medRxiv, biorxiv
...
- **Contains:** grant data, patent links, citation data, paper metadata, venue data, author data
- **Status:** VALUABLE, ACTIVE
