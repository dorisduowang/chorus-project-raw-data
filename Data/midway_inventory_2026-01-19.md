...
**Last Updated:** 2026-01-19T02:00:04.288272
...
### openalex-snapshot
- **Also known as:** OA, OpenAlex, Microsoft Academic, MAG, Microsoft Academic Graph
...
- **Contains:** model configs, institution data, paper metadata, model weights, citation links, author data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, institution data, paper metadata, citation data, patent links, citation links, author data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** bioRxiv, BioRxiv, arxiv, ArXiv, medRxiv, medrxiv, MedRxiv, arXiv, biorxiv
...
- **Contains:** grant data, venue data, paper metadata, citation data, patent links, author data
- **Status:** VALUABLE, ACTIVE
