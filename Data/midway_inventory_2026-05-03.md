...
**Last Updated:** 2026-05-03T02:00:06.457854
...
### openalex-snapshot
- **Also known as:** OA, MAG, Microsoft Academic, OpenAlex, Microsoft Academic Graph
...
- **Contains:** model configs, model weights, text, web pages, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, user data, messages, comments, channel data
- **Status:** VALUABLE
...
### arxiv
- **Also known as:** arxiv, arXiv, bioRxiv, biorxiv, BioRxiv, ArXiv, medrxiv, medRxiv, MedRxiv
