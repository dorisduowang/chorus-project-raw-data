...
**Last Updated:** 2026-01-24T02:00:04.877982
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** paper metadata, grant data, citation data, patent links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, text, web pages, model configs, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** paper metadata, author data, grant data, institution data, citation links, citation data, patent links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** ArXiv, bioRxiv, MedRxiv, biorxiv, arxiv, BioRxiv, arXiv, medRxiv, medrxiv
...
- **Contains:** paper metadata, author data, grant data, venue data, citation data, patent links
- **Status:** VALUABLE, ACTIVE
