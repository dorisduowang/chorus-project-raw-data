...
**Last Updated:** 2026-01-15T08:11:28.447188
...
### openalex-snapshot
- **Also known as:** OpenAlex, Microsoft Academic Graph, MAG, Microsoft Academic, OA
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, channel data, posts, messages, user data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, citation links, paper metadata, institution data, citation data, patent links, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** MedRxiv, biorxiv, medrxiv, BioRxiv, bioRxiv, ArXiv, medRxiv, arXiv, arxiv
...
- **Contains:** venue data, author data, paper metadata, grant data, citation data, patent links
- **Status:** VALUABLE, ACTIVE
