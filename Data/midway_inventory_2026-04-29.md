...
**Last Updated:** 2026-04-29T02:00:03.953058
...
- **Also known as:** S2AG, S2, Semantic Scholar, SemanticScholar
...
### openalex-snapshot
- **Also known as:** OpenAlex, MAG, OA, Microsoft Academic, Microsoft Academic Graph
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** paper metadata, patent links, citation data, grant data
- **Status:** VALUABLE, ACTIVE
...
- **Type:** Major Data Snapshot Directory
- **Contains:** legal status, patent bibliographic data, patent citations
- **Status:** VALUABLE, ACTIVE
...
### PwC_Mar_04_2025
- **Also known as:** PwC, PapersWithCode, Papers with Code
...
- **Contains:** institution data, citation links, author data, model weights, model configs, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, text, model configs, web pages, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, comments, channel data, user data, messages
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** institution data, patent links, citation data, grant data, citation links, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arXiv, medrxiv, medRxiv, MedRxiv, ArXiv, bioRxiv, arxiv, biorxiv, BioRxiv
...
- **Contains:** patent links, venue data, citation data, grant data, author data, paper metadata
- **Status:** VALUABLE, ACTIVE
