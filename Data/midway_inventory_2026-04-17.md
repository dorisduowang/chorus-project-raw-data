...
**Last Updated:** 2026-04-17T02:00:05.150735
**Total Resources:** 142 directories
...
**Other Data:** corpora, Dawoon_APTO_data
...
- **Also known as:** SemanticScholar, S2AG, Semantic Scholar, S2
...
### openalex-snapshot
- **Also known as:** MAG, OpenAlex, Microsoft Academic, Microsoft Academic Graph, OA
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation links, paper metadata, author data, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation data, grant data, paper metadata, patent links
- **Status:** VALUABLE, ACTIVE
...
- **Also known as:** MAG, Microsoft Academic Graph, Microsoft Academic
...
- **Contains:** venue data, paper metadata, author data
- **Status:** VALUABLE, ACTIVE
...
### PATSTAT
- **Also known as:** PATSTAT, EPO PATSTAT
- **Path:** `/project/jevans/PATSTAT`
- **Owner:** lkcao
- **Size:** 64 GB
- **Category:** Patent Database
- **Type:** Major Data Snapshot Directory
- **Contains:** patent bibliographic data, legal status, patent citations
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** HTML data, preprint metadata, abstracts
...
### PKG_v2_2023
- **Also known as:** PubMed Knowledge Graph, PKG
- **Path:** `/project/jevans/PKG_v2_2023`
- **Owner:** kangd
- **Size:** 144 GB
- **Category:** Biomedical Knowledge Graph
- **Type:** Major Data Snapshot Directory
- **Contains:** knowledge graph, entity linkages, grant-paper links
- **Status:** VALUABLE
...
- **Contains:** chemical structures, compound data
...
- **Contains:** drug metadata, drug-target interactions
...
- **Contains:** comments, user data, posts
...
### PwC_Mar_04_2025
- **Also known as:** Papers with Code, PwC, PapersWithCode
- **Path:** `/project/jevans/PwC_Mar_04_2025`
- **Owner:** kangd
- **Size:** 0.0 MB
- **Category:** ML Benchmark Data
- **Contains:** paper-code links, benchmark data
...
### Dawoon_APTO_data
- **Path:** `/project/jevans/Dawoon_APTO_data`
- **Owner:** jdwoon0523
- **Size:** 0.0 MB
...
- **Contains:** model configs, author data, institution data, model weights, citation links, paper metadata
- **Status:** VALUABLE, ACTIVE
...
### akozlo
- **Also known as:** Common Crawl, CommonCrawl
- **Path:** `/project/jevans/akozlo`
- **Owner:** akozlo
- **Size:** 214 GB
- **Category:** Web Crawl Data
- **Type:** Individual Researcher Directory
- **Contains:** model configs, HTML, text, model weights, web pages
- **Status:** VALUABLE, ACTIVE
...
### adarshm
- **Also known as:** Reddit, Telegram
- **Path:** `/project/jevans/adarshm`
- **Owner:** adarshm
- **Size:** 76 GB
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, user data, posts, comments, messages
- **Status:** VALUABLE
...
### Dawoon
- **Also known as:** Dimensions, OpenAlex, OA
- **Path:** `/project/jevans/Dawoon`
- **Owner:** jdwoon0523
- **Size:** 50-100 MB
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, author data, institution data, citation data, citation links, paper metadata, patent links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, bioRxiv, arXiv, medRxiv, ArXiv, arxiv, BioRxiv, medrxiv, MedRxiv
- **Path:** `/project/jevans/arxiv`
- **Owner:** jsourati
- **Size:** 4 GB
- **Category:** Preprint Server Data
- **Type:** Data Snapshot Directory
- **Contains:** preprint metadata, abstracts, categories
- **Status:** VALUABLE
...
### donghyun
- **Also known as:** dblp, Dimensions, DBLP
- **Path:** `/project/jevans/donghyun`
- **Owner:** kangd
- **Size:** 1-5 GB
- **Category:** Computer Science Bibliography
- **Type:** Individual Researcher Directory - Extensive Projects
- **Contains:** grant data, author data, citation data, venue data, paper metadata, patent links
- **Status:** VALUABLE, ACTIVE
...
- `CommonCode` (owner: rbward, path: `/project/jevans/CommonCode`)
...
- `autointerp_outputs` (owner: akozlo, path: `/project/jevans/autointerp_outputs`)
- `autointerp_upload` (owner: akozlo, path: `/project/jevans/autointerp_upload`)
- `claude_code_log` (owner: giochoi, path: `/project/jevans/claude_code_log`)
- `feature_bank` (owner: akozlo, path: `/project/jevans/feature_bank`)
...
- `hongbofang2` (owner: hongbofang, path: `/project/jevans/hongbofang2`)
- `impact-playground` (owner: gusellerm, path: `/project/jevans/impact-playground`)
...
- `wflowers` (owner: wflowers, path: `/project/jevans/wflowers`)
...
- `zehanli` (owner: zehan, path: `/project/jevans/zehanli`)
