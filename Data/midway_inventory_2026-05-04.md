...
**Last Updated:** 2026-05-04T02:00:07.944281
...
### openalex-snapshot
- **Also known as:** OpenAlex, OA, MAG, Microsoft Academic, Microsoft Academic Graph
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** citation links, author data, institution data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** patent links, citation data, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** abstracts, preprint metadata, HTML data
...
- **Contains:** model weights, paper metadata, citation links, institution data, model configs, author data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, model configs, web pages, HTML, text
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, comments, channel data, messages, posts
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, paper metadata, citation links, institution data, grant data, citation data, author data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** bioRxiv, arxiv, BioRxiv, ArXiv, medrxiv, medRxiv, biorxiv, MedRxiv, arXiv
...
- **Contains:** patent links, paper metadata, venue data, grant data, citation data, author data
- **Status:** VALUABLE, ACTIVE
