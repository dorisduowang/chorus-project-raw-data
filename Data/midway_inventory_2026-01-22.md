...
**Last Updated:** 2026-01-22T02:00:08.245925
...
### openalex-snapshot
- **Also known as:** OpenAlex, Microsoft Academic Graph, Microsoft Academic, OA, MAG
...
- **Contains:** author data, institution data, citation links, model weights, model configs, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, HTML, web pages, model weights, model configs
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, medrxiv, arxiv, arXiv, bioRxiv, BioRxiv, ArXiv, medRxiv, MedRxiv
...
- **Contains:** grant data, author data, citation data, paper metadata, venue data, patent links
- **Status:** VALUABLE, ACTIVE
