...
**Last Updated:** 2026-04-25T02:00:05.556867
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, Microsoft Academic Graph, OpenAlex, OA, MAG
- **Path:** `/project/jevans/openalex-snapshot`
- **Owner:** beichenlu
- **Size:** Unknown
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** paper metadata, institution data, author data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Type:** Major Data Snapshot Directory
- **Contains:** patent citations, patent bibliographic data, legal status
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** author data, model weights, model configs, citation links, paper metadata, institution data
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** text, model weights, web pages, HTML, model configs
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** comments, posts, user data, channel data, messages
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** author data, patent links, citation data, citation links, paper metadata, grant data, institution data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** biorxiv, arXiv, BioRxiv, MedRxiv, bioRxiv, medRxiv, medrxiv, arxiv, ArXiv
...
- **Contains:** author data, patent links, citation data, venue data, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
