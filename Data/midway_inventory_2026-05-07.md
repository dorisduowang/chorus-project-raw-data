...
**Last Updated:** 2026-05-07T02:00:06.042884
...
- **Also known as:** SemanticScholar, S2AG, S2, Semantic Scholar
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, Microsoft Academic Graph, OpenAlex, MAG, OA
...
- **Category:** Bibliographic Database
- **Type:** Major Data Snapshot Directory
- **Contains:** grant data, patent links, citation data, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model weights, paper metadata, author data, institution data, model configs, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** web pages, model weights, text, model configs, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** channel data, posts, comments, user data, messages
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, citation data, paper metadata, grant data, author data, institution data, citation links
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** patent links, citation data, paper metadata, grant data, author data, venue data
- **Status:** VALUABLE, ACTIVE
