...
**Last Updated:** 2026-03-14T02:00:06.992675
...
- **Contains:** citation links, model weights, author data, institution data, model configs, paper metadata
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** grant data, citation data, citation links, author data, institution data, paper metadata, patent links
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** arxiv, MedRxiv, bioRxiv, BioRxiv, ArXiv, medRxiv, arXiv, medrxiv, biorxiv
...
- **Contains:** grant data, citation data, venue data, author data, paper metadata, patent links
- **Status:** VALUABLE, ACTIVE
