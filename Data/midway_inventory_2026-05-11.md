...
**Last Updated:** 2026-05-11T02:00:06.457557
...
### openalex-snapshot
- **Also known as:** Microsoft Academic, Microsoft Academic Graph, MAG, OA, OpenAlex
...
- **Contains:** model configs, citation links, paper metadata, institution data, author data, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model configs, HTML, text, web pages, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** posts, comments, messages, user data, channel data
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** patent links, citation data, citation links, grant data, paper metadata, institution data, author data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** medRxiv, bioRxiv, MedRxiv, BioRxiv, arxiv, arXiv, biorxiv, ArXiv, medrxiv
...
- **Contains:** venue data, patent links, citation data, grant data, paper metadata, author data
- **Status:** VALUABLE, ACTIVE
