...
**Last Updated:** 2026-04-10T02:00:05.847669
...
### openalex-snapshot
- **Also known as:** Microsoft Academic Graph, OpenAlex, Microsoft Academic, MAG, OA
...
- **Contains:** author data, citation links, paper metadata, institution data, model configs, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** HTML, web pages, text, model configs, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** user data, channel data, comments, posts, messages
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation data, author data, citation links, patent links, paper metadata, institution data, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** bioRxiv, BioRxiv, arxiv, MedRxiv, ArXiv, medRxiv, medrxiv, arXiv, biorxiv
...
- **Contains:** venue data, citation data, author data, patent links, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
