...
**Last Updated:** 2026-03-28T02:00:05.853957
...
### openalex-snapshot
- **Also known as:** MAG, Microsoft Academic, OpenAlex, Microsoft Academic Graph, OA
...
- **Contains:** model configs, citation links, institution data, author data, paper metadata, model weights
- **Status:** VALUABLE, ACTIVE
...
- **Contains:** model configs, web pages, text, model weights, HTML
- **Status:** VALUABLE, ACTIVE
...
- **Category:** Social Media Data
- **Type:** Individual Researcher Directory
- **Contains:** messages, posts, channel data, user data, comments
- **Status:** VALUABLE
...
- **Category:** Bibliographic Database
- **Type:** Individual Researcher Directory
- **Contains:** citation links, institution data, citation data, patent links, author data, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
...
### arxiv
- **Also known as:** BioRxiv, MedRxiv, biorxiv, medrxiv, arxiv, medRxiv, ArXiv, bioRxiv, arXiv
...
- **Contains:** citation data, patent links, author data, venue data, paper metadata, grant data
- **Status:** VALUABLE, ACTIVE
